# ymir_key.ps1 -- send keystrokes to the Ymir window from a background process.
#
...
#
# Usage:
#   powershell -File tools/ymir_key.ps1 -Keys F12
#   powershell -File tools/ymir_key.ps1 -Keys F11 -Ctrl
#   powershell -File tools/ymir_key.ps1 -Keys J -Hold 400
param(
