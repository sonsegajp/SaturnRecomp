...
int WINAPI wWinMain(HINSTANCE a,HINSTANCE b,PWSTR c,int d) {
    ...
    wchar_t folder[32768],runtime[32768],cmd[32768],settings[32768],absolute[32768];
    ...
    /* The shared runtime loads all persisted options from this explicit path.
       Do not turn the saved preference into a diagnostic environment override:
       that would defeat later changes made by the in-game settings overlay. */
